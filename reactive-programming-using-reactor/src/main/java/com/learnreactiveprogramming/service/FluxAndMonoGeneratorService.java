...
// ouput will be in interleave fashion like 'A','D','B','E','C','F'
    ...
    /*
 1. Used to combine two publishers (Flux) in to one.
 2. static method in flux
 3. Both the publishers are subscribed at the same time.(emitting the values at the same time).
   - publishers are subscribed eagerly.
 4. Even though publishers are subscribed eagerly the merge happens in a sequence
 */
    ...
    public Flux<String> explore_zipWith(){
        ...
        return abcFlux.zipWith(defFlux, (first,second)->first+second);// output is AD,BE,CF
    }
